...
/**
 * ============================================================
 * export_excel.php - Export stages to Excel
 * ============================================================
 * 
 * Generates an Excel file with all data from usn_stages (L10) 
 * or rack_stages (L11) table with formatting and styles
 * 
 * ============================================================
 */
...
// Build dynamic query
$select_columns = ['usn', 'rack_pn', 'model', 'batch', 'current_stage', 'test_start_time'];
...
$sql = "SELECT " . implode(', ', $select_columns) . " FROM {$table} ORDER BY usn";
...
$filename = $table . '_' . date('Y-m-d_His') . '.xls';
